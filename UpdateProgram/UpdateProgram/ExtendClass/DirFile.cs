...
namespace DotNet.Utilities
{
    ...
    public static class DirFile
    {
        ...
        public static ArrayList GetFileAndDirectoryNames(string directoryPath)
        {
            ...
            ArrayList fileAnddirectory = new ArrayList();
            //获取文件列表
            string[] filename = Directory.GetFiles(directoryPath);
            //获取目录列表
            string[] directoryname = Directory.GetDirectories(directoryPath);
            //将文件名和文件夹名导入ArrayList中
            for (int i = 0; i < filename.Length; i++)
            {
                fileAnddirectory.Add(filename[i]);
            }
        ...
        public static void CreateDir(string dir)
        {
            ...
            if (!Directory.Exists(AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\" + dir))
                Directory.CreateDirectory(AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\" + dir);
        }
        #endregion
