...
namespace DotNet.Utilities
{
    public class XMLProcess
    {
        ...
        /// </summary>
        /// <param name="XMLPath">XML文件路径</param>
        public static XmlDocument XMLLoad(string strPath)
        {
            XmlDocument xmldoc = new XmlDocument();
            try
            {
        ...
        public static string Read(string path, string node0, string node1, string node2)
        {
            string value = "";
            try
            {
                XmlDocument doc = XMLLoad(path);
                XmlNode xn0 = doc.SelectSingleNode(node0);
                XmlNode xn1 = xn0.SelectSingleNode(node1);
                XmlNode xn2 = xn1.SelectSingleNode(node2);
                value = xn2.InnerText;
            }
            catch(Exception e) 
            {
